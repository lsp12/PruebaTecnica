...
export const apiPokeByUrl = createAsyncThunk('getApi/apiPokeByUrl', async (url: string) => {
  try {
...
export const apiPokeByName = createAsyncThunk('getApi/apiPokeByName', async (name: string) => {
  try {
